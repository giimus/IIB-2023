function doGet(e) { 
 ...
 var sheet_id = '16tNNZnQGZHNV8lPriUPU_lVBiab5EpagsKYfrldCXR4';  // Spreadsheet ID
 ...
 break;
 case 'value4': //Parameter 3, It has to be updated in Column in Sheets in the code, orderwise
 rowData[5] = value; //Value in column C
 result += ' Written on column D';
 break;
 case 'value5': //Parameter 3, It has to be updated in Column in Sheets in the code, orderwise
 rowData[6] = value; //Value in column C
 result += ' Written on column E';
 break;
 case 'value6': //Parameter 3, It has to be updated in Column in Sheets in the code, orderwise
 rowData[7] = value; //Value in column C
 result += ' Written on column F';
 break;
 case 'value7': //Parameter 3, It has to be updated in Column in Sheets in the code, orderwise
